...
public class load extends javax.swing.JFrame {
    ...
    ld.setLocationRelativeTo(null);
            try{
                for(int i=0;i<=100;i++){
                    Thread.sleep(100);
                    if(i==30){
                        ld.ldtext.setText("Memeriksa Cart...");
                    }
                    if(i==45){
                        ld.ldtext.setText("Mencari Kurir...");
                    }
                    if (i==70) {
                        ld.ldtext.setText("Mendapatkan Kurir...");
                    }  
                }
            }catch (Exception e) {
    ...
    private void initComponents() {
        ...
        ldtext.setText("Memproses Pembayaran...");
        getContentPane().add(ldtext);
        ldtext.setBounds(200, 350, 320, 40);

        jLabel5.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/uang uang uang.png"))); // NOI18N
        getContentPane().add(jLabel5);
        jLabel5.setBounds(240, 140, 250, 170);
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        ...
        ld2.setVisible(true);
        ld2.pack();
        ld2.setLocationRelativeTo(null);
        this.dispose();
